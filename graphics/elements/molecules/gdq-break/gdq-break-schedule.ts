...
import {IGdqBreakScheduleRun} from './gdq-break-schedule-run';
...
window.addEventListener('load', () => {
	...
	class GdqBreakSchedule extends Polymer.MutableData(Polymer.Element) {
		...
		_$runs: NodeListOf<IGdqBreakScheduleRun>;
		...
		ready() {
			...
			this._$runs = this.shadowRoot!.querySelectorAll('gdq-break-schedule-run') as NodeListOf<IGdqBreakScheduleRun>;
		}
	...
	(window as any).GdqBreakSchedule = GdqBreakSchedule;
});
